...
const PlantDB = () => (
  <div>
    <h1 className="title is-1">This is the Plant Database</h1>
    <p>
      ...
      Suspendisse in est ante in nibh mauris cursus. Cursus vitae congue mauris
      rhoncus aenean vel elit. Quis auctor elit sed vulputate mi sit amet mauris
      commodo.
    </p>
  </div>
);
